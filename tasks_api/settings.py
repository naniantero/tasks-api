...
SECRET_KEY = 'django-insecure-+y9nsq=^qio%$7461jq6_nfe*)!wm7b@#*k)d*!-mfd3^*su#-'
...
DATABASES = {
    'default': {
        ...
        'NAME': str(config('POSTGRES_DB', default='')),
        'USER': str(config('POSTGRES_USER', default='')),
        'PASSWORD': str(config('POSTGRES_PASSWORD', default='')),
